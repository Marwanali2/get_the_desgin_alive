...
class _PetsViewBodyState extends State<PetsViewBody> {
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          searchBox(),
          // list view of pets containers
          petsContainersListView(context),
        ],
      ),
    );
  }
  ...
  Padding petsContainersListView(BuildContext context) {
    return Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                if(searchText.isEmpty){
                 ...
                 // display searched pets based on result of search
                 return Padding(
